...
class CarController extends Controller
{
    ...
    public function uploadImage(Request $request, $id): JsonResponse
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                'car_image' => 'required|image|mimes:jpeg,png,jpg,gif|max:5120', // 5MB max
            ]);
            ...
            if ($request->hasFile('car_image')) {
                ...
                $filename = 'car_' . $car->id . '_' . time() . '.' . $file->getClientOriginalExtension();
                
                // Store file in public/cars directory
