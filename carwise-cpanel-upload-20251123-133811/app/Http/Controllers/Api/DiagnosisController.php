    ...
    public function startDiagnosis(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $session = DiagnosisSession::create([
                ...
                'symptoms' => is_array($request->symptoms) ? $request->symptoms : ($request->symptoms ? [$request->symptoms] : []),
                'status' => 'processing',
                'created_at' => now()
            ]);
