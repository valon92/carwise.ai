...
const routes = [
  ...
  },
  {
    ...
    component: lazyRoute('SubscriptionPlans'),
    meta: { 
      requiresAuth: true
    }
  },
      ...
      template: `
        <div class="min-h-screen bg-gray-50 py-8">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Subscription Dashboard</h1>
            <div class="bg-white rounded-lg shadow-sm p-6">
              <h2 class="text-xl font-semibold text-gray-900 mb-4">Test Page</h2>
              <p class="text-gray-600">This is a test page to verify the subscription dashboard is working.</p>
              <div class="mt-6">
